                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="edit.php?id=<?php echo $turma['id']; ?>" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"><i class='bx bx-edit-alt text-xl'></i></a>
                                    <a href="delete.php?id=<?php echo $turma['id']; ?>" onclick="return confirm('Deseja excluir esta turma?')" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors"><i class='bx bx-trash text-xl'></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach ?>
