                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="px-6 py-4 font-mono font-semibold text-slate-400">#2026001</td>
                            <td class="px-6 py-4 font-semibold text-slate-900">Carlos Henrique Silva</td>
                            <td class="px-6 py-4 text-slate-500">3º Ano A</td>
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a href="delete.php?id=1" onclick="return confirm('Deseja excluir este aluno?')" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors"><i class='bx bx-trash text-xl'></i></a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
