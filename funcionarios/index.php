                    ...
                    <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                        <?php foreach ($funcionarios as $funcionario): ?>
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                <td class="px-6 py-4 font-mono font-semibold text-slate-400"><?php echo $funcionario['id']; ?></td>
                                <td class="px-6 py-4 font-semibold text-slate-900"><?php echo $funcionario['nome']; ?></td>
                                <td class="px-6 py-4 text-slate-500"><?php echo $funcionario['cargo']; ?></td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="edit.php?id=<?php echo $funcionario['id']; ?>" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"><i class='bx bx-edit-alt text-xl'></i></a>
                                        <a href="delete.php?id=<?php echo $funcionario['id']; ?>" onclick="return confirm('Deseja excluir este funcionário?')" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors"><i class='bx bx-trash text-xl'></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
